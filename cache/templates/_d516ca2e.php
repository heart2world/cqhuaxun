...
<?php endforeach;?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="img_list_page_met_36_1" m-id="<?php echo $ui['mid'];?>">
	<div class="
		    <?php if($ui[is_full]==1){ ?>
...
?>
			<?php endforeach;?>
			<ul id="met-grid" class="img_list_page_met_36_1-list fngallery portfolio-list no-space met-pager-ajax imagesize met-img-list     <?php if($ui[mobile_img_num]==1){ ?>
			blocks-100
			<?php }else{ ?>
