...
?><?php endforeach;?>
                <?php if($sub){ ?>
                    <?php if($_M['form']['pageset']){ ?>
                        <?php if($sidebar){ ?>
                        <div class="col-md-9 met-news-body     <?php if($ui[boxposition]){ ?>fl_left<?php }else{ ?>fl_right<?php } ?>">
                            <div class="row     <?php if($sidebar && $ui[boxposition]){ ?>paddingR<?php }else{ ?>paddingL<?php } ?>">
                    <?php } ?>
                <?php }else{ ?>
...
<div class="col-md-3">
	<div class="row">
<aside class="sidebar_met_28_1 met-sidebar panel panel-body m-b-0" boxmh-h m-id='<?php echo $ui['mid'];?>' m-type='nocontent'>
	    <?php if($ui[input]){ ?>
...
?>
			...
			<li class="list-group-item ">
				<a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>" <?php echo $g['urlnew'];?> class="<?php echo $active;?>"><?php echo $v['title'];?></a>
			</li>
			<?php endforeach;?>
		</ul>
	</div>
